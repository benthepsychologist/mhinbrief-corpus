...
(`mhinbrief`) and **the engine** (`kestrel`). The split
...
| **ops** — an incident, a drift report, anything naming a live repo, a path, or a run | `kestrel-ops/INBOX/<date>-mhinbrief-<slug>.md` |
